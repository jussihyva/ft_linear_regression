...
#    Updated: 2021/08/11 18:38:04 by jkauppi          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

SRC_C_FILES		=	input_read_dataset_file.c cmd_arguments.c \
					linear_regression.c input_read_mileage.c input_usage.c \
					...
					residual.c error.c influxdb_remove.c arg_parser_init.c
